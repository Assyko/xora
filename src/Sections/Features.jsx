        ...
        <div className="container">
          ...
          >
            {features.map(({ id, icon, caption, title, text, button }) => (
              <div
                key={id}
                className="relative z-2 md:px-10 px-5 md: pb-5 flex-50 max-md:g7 max-md:border-2 max-md:border-s3
                 max-md:rounded-3xl max-md:flex-320"
              >
                <div className="w-full flex justify-start items-center">
                  <div className="-ml mb-12 flex items-center justify-center flex-col">
            ...
            >
              ...
              {details.map(({ id, icon, title }) => (
                <li key={id} className="relative pt-16 px-4 pb-14">
                  ...
                  <h3 className="relative z-2 max-w-36 mx-auto my-0 text-center uppercase">
                    {" "}
                    {title}
                  </h3>
                </li>
