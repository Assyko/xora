    ...
    <section>
      <Element name="pricing">
        <div className="container">
          ...
          border-l border-r border-s2 bg-s1/50 pb-40 pt-28
            max-xl:max-w-4xl max-lg:border-none max-md:pb-32 maxmd:pt-16"
          >
            <h3
              className="h3 max-lgh4 max-md:h5 z-30relative mx-auto mb-14
            maxwlg text-center text-p4 max-md:mb-11 max-sm:max-w-sm"
            >
              Flexible pricing for teams of all sizes
            </h3>
            <div
              className="relative z-4 mx-auto max-w-md flex w-[375px] rounded-3xl
            ...
            <div className="pricing-bg">
              ...
              <img
                ...
                height={380}
                alt="outline"
                className="absolute z-2 inset-0 opacity-5 mix-blend-soft-light"
              />
            </div>
          </div>
          {/*  pricing*/}
          <div
            className="scroll-hide relative z-2 -mt-12 flex
